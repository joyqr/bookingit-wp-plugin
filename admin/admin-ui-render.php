...
function bookingit_general_settings_field_callback() {
	...
	<fieldset>
		<!-- Text Input -->
		<input type="text" name="bookingit_settings[bookingit_venue_slug]" class="regular-text" value="<?php if ( isset( $settings['bookingit_venue_slug'] ) && ( ! empty($settings['bookingit_venue_slug']) ) ) echo esc_attr($settings['bookingit_venue_slug']); ?>"/>
...
function bookingit_admin_interface_render () {
	...
	if ( isset( $_GET['settings-updated'] ) ) {
		...
		add_settings_error( 'bookingit_settings_saved_message', 'bookingit_settings_saved_message', __( 'Settings are Saved', 'bookingit' ), 'updated' );
	}
 
	// Show Settings Saved Message
	settings_errors( 'bookingit_settings_saved_message' ); */?>
	<div class="wrap">
        ...
        <?php
			...
			settings_fields( 'bookingit_settings_group' );
        ?>
            ...
            <table class="form-table bi-info">
                <tbody>
                    <tr>
                        ...
                        <td>
                            <div>
                                <input type="text" id="bi-shortcode" disabled value="<?php echo BOOKINGIT_SHORTCODE; ?>" />
...
<!--            <code>-->
<!--                --><?php
//                esc_html_e(bookingit_get_embed_html('test-slug'));
//                ?>
<!--            </code>-->
			<?php
